...
- #### Unity Version
	Although the UnityGLTF Project is maintained at Unity version 5.6.5f1, make sure that the Unity release you have installed on your local machine is up to date. You can download the free version [here](https://unity3d.com/get-unity/download/archive). (need explanation). You can run this project simply by opening as a project on Unity.
- ##### Project Components
